...
%{
dataset1 = load('Datasets/dataset1');

neg_examples_nobias = dataset1(1).neg_examples_nobias;
pos_examples_nobias = dataset1(1).pos_examples_nobias;
w_gen_feas = dataset1(1).w_gen_feas;
w_init = dataset1(1).w_init;
%}
